  ...
  return (
    <div className='pt-20'>
      ...
      <section className="home">
        <div className="flex justify-between mx-auto pl-32 py-28 text-black  lg:pl-8 lg:flex">
      ...
      <div className='flex items-center justify-center'>
        <a href="#_" className="relative inline-flex items-center justify-start px-5 py-3 overflow-hidden font-medium transition-all duration-300 bg-white border-2 border-[#f1e9fc] rounded-full group">
