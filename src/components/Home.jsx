        ...
        <div className="items-center px-4 max-w-screen-xl mx-auto md:px-8 lg:flex">
          <div className="flex items-center justify-between py-3 lg:py-4 lg:block">
            <a href="javascript:void(0)">
              <div className="flex items-center justify-center gap-2">
                <img src="https://cdn.prod.website-files.com/639b3e775b326dcf7cea3e70/639b3e775b326d7e3bea3f1d_Crest%20fevicon.png" width={10} height={10} alt="CleverReader Logo" className="w-10" />
                <h1 className="text-white text-2xl">CleverReader</h1>
              </div>
            </a>
            <div className="lg:hidden">
              <button className="text-white outline-none p-2 rounded-md focus:[#000000] focus:border" onClick={() => setState(!state)}>
                {state ? (
          ...
          <div
            className={`flex-1 justify-between flex-row-reverse lg:overflow-visible lg:flex lg:pb-0 lg:pr-0 lg:h-auto ${
              state ? 'h-screen pb-20 overflow-auto pr-4 bg-[#000000] bg-opacity-70' : 'hidden'
            }`}
          >
            <div>
              <ul className="flex flex-col-reverse space-x-0 lg:space-x-6 lg:flex-row">
                <li className="mt-4 lg:mt-0">
                  <a
                    ...
                    className="py-3 px-4 font-bold text-center border transition-colors duration-700 hover:transition-colors hover:duration-700 bg-gradient-to-br from-salmon to-medium-purple inline-block text-transparent bg-clip-text hover:text-white rounded-md block lg:inline lg:border-0"
                  >
                    Login
                  </a>
                </li>
                <li className="mt-8 rounded-2xl lg:mt-0">
                  <a
                    href="javascript:void(0)"
                    className="py-3 px-5 text-center text-white bg-gradient-to-br from-salmon to-medium-purple hover:text-[#000000] hover:bg-gradient-to-r from-salmon to-medium-purple rounded-full shadow block lg:inline"
                  >
                    Talk To Us
                  </a>
                </li>
        ...
        <div className="flex justify-between   mx-auto  pl-32 py-28  text-white  overflow-hidden lgpx-8 lg:flex">
          <div className="flex-none pt-10 space-y-5 max-w-xl">
            <div className="text-6xl text-white font-bold sm:text-6xl">
              <p className="text-6xl text-white pb-5 font-bold sm:text-6xl">Every order</p>
              <p>
            ...
            <p className="font-bold pb-7 pt-6">
              Eliminate overstocking and under-stocking with Crest. Built by supply-chain experts, it brings the same technology used by large global brands to power fast-growing startups. In short,
              we make supply meet demand, and then help you grow both.{' '}
            </p>
            <div className="flex items-start gap-x-3 sm:text-sm">
              <a href="#_" class="relative inline-flex items-center justify-start px-5 py-3 overflow-hidden font-medium transition-all duration-300 bg-[#000000] rounded-full group">
