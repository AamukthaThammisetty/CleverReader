  ...
  <section className="py-16">
    <div className="max-w-screen-xl mx-auto px-2 md:px-8">
      <div className=" flex justify-center ">
        <h1 className="text-[#000000] text-3xl pb-6 flex justify-center font-extrabold sm:text-4xl">Four key questions answered by Crest</h1>
      </div>
          ...
          <li className=" bg-[#f1e9fc] rounded-3xl">
            <div className="flex items-start justify-between p-4">
              <div className="  p-4 space-y-2">
                ...
                <h4 className="text-[#000000] text-2xl font-bold ">{item.title}</h4>
                <p className="text-[#000000] text-md">{item.desc}</p>
              </div>
            </div>
          </li>
        ))}
