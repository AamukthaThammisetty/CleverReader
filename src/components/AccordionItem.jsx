      ...
      <button className={`faq-btn flex w-full text-left`} onClick={handleToggle}>
        <div className="w-full">
          <h4
            className={`${
              active
                ? 'mt-1 text-2xl  font-semibold text-dark dark:text-white bg-gradient-to-br from-salmon to-medium-purple inline-block text-transparent bg-clip-text'
                : 'mt-1 text-2xl font-semibold text-[#000000] dark:text-white'
            }`}
          >
            {header}
          </h4>
