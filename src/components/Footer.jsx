...
const Footer = () => {
  ...
  const footerNavs = [
    ...
    },
    {
      ...
      items: [
        {
          href: 'javascript:void()',
          name: 'sales@getcrest.ai',
        },
        {
          href: 'javascript:void()',
          name: '1507, Incubex, 11th cross road, 19th Main Road, Bengaluru, India. 560102',
        },
        {
          href: 'javascript:void()',
          name: 'Corporate Office:291, All Time Space, 4th Floor,HSR Layout, Bengaluru,India. 560102 ',
        },
      ],
    },
  ]
  ...
  return (
    <footer className="text-white bg-[#000000] px-32 py-20  mx-auto ">
      <div className="flex justify-around md:flex">
        <div className="">
          <div className="max-w-xs">
            ...
            <p className="leading-relaxed mt-2 text-[15px]">
              Crest is an AI-powered supply chain software that provides companies tools for demand forecasting, inventory planning and more. This helps them have the right amount of stock, optimise
              space and fulfil every order.
            </p>
          </div>
        </div>
        <div className=" mt-10 gap-9 space-y-6  sm:flex md:space-y-0 md:mt-0">
      ...
      <div className="mt-6 pl-96 ml-64 sm:mt-0">
      ...
      <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0">&copy; 2022 cleverReader All rights reserved.</div>
        <li className="w-10 h-10 border rounded-full flex items-center justify-center">
